  ...
  return (
    <div>
      <label className="flex items-start gap-2 sm:gap-3 cursor-pointer group">
        <motion.div
          className="relative w-4 h-4 sm:w-5 sm:h-5 mt-0.5 rounded-md shrink-0"
          style={{
...
const socialIcons = {
  google: (
    <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24">
      ...
      <path fill="#FBBC05" d="M5.27698177,14.2678769 C5.03832634,13.556323 4.90909091,12.7937589 4.90909091,12 C4.90909091,11.2182781 5.03443647,10.4668121 5.26620003,9.76452941 L1.23999023,6.65002441 C0.43658717,8.26043162 0,10.0753848 0,12 C0,13.9195484 0.444780743,15.7344181 1.23746264,17.3349879 L5.27698177,14.2678769 Z"/>
    </svg>
  ),
  apple: (
